                                ...
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column">
                                        <div class="column_attr clearfix">
                                            <div class="container">
                                                <div class="title">Formulaire de Collaboration</div>
                                                <div class="content">
                                                  <form
                                                    action="https://formspree.io/f/xnqknrdk"
                                                    method="POST"
                                                  >
                                                    <div class="user-details">
                                                      ...
                                                      <div class="input-box">
                                                        ...
                                                        <input
                                                          type="text"
                                                          placeholder="Enter Nom d'entreprise"
                                                          required
                                                          name="entreprise"
                                                        />
                                                      </div>
                                                    ...
                                                    <div class="input-box">
                                                      <span class="details">Collaboration</span>
                                                      <textarea name="Collaboration" id="" cols="80" rows="10"></textarea>
                                                    </div>
                                                    <div class="button">
