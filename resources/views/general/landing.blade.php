                                ...
                                <div class="mcb-wrap-inner">
                                    ...
                                    <div class="column mcb-column one-second column_button">
                                        <a class="button button_right button_size_2 button_theme button_js"
                                            href="{{ asset('landing/assets/content/agency3/about.html') }}"><span
                                        ...
                                        <div class="image_frame image_item no_link scale-with-grid alignright no_border">
                                            <div class="image_wrapper">
                                                <img class="scale-with-grid"
                                                    src="{{ asset('landing/assets/content/agency3/images/home_agency3_pic1.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_image">
                                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                                            <div class="image_wrapper">
                                                <img class="scale-with-grid"
                                                    src="{{ asset('landing/assets/content/agency3/images/home_agency3_pic2.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="wrap mcb-wrap one valign-top move-up clearfix" style="margin-top:-250px"
                                ...
                                <div class="mcb-wrap-inner">
                                    ...
                                    <div class="column mcb-column two-fifth column_column">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic3.png') }}'); background-repeat:no-repeat; background-position:left top; padding:120px 40px 40px;">
                        ...
                        <div class="section_wrapper mcb-section-inner">
                            ...
                            <div class="wrap mcb-wrap one-second valign-top clearfix" style="padding:0 4% 0 0">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column  column-margin-10px">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic4.png') }}'); background-repeat:no-repeat; background-position:left top; padding:0 0 10px 80px;">
                                            <h4>Centre
                                                <br> D'appel
                                            </h4>
                                        </div>
                            ...
                            <div class="wrap mcb-wrap one-second valign-top clearfix" style="padding:0 4% 0 0">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column  column-margin-10px">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic5.png') }}'); background-repeat:no-repeat; background-position:left top; padding:0 0 10px 80px;">
                                            <h4>Traitement
                            ...
                            <div class="wrap mcb-wrap one-second valign-top clearfix" style="padding:0 4% 0 0">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column  column-margin-10px">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic6.png') }}'); background-repeat:no-repeat; background-position:left top; padding:0 0 10px 80px;">
                                            <h4>Community
                                                <br> Manager
                                            </h4>
                                        </div>
                            ...
                            <div class="wrap mcb-wrap one-second valign-top clearfix" style="padding:0 4% 0 0">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column  column-margin-10px">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic7.png') }}'); background-repeat:no-repeat; background-position:left top; padding:0 0 10px 80px;">
                                            <h4>Photo & vidéo
                            ...
                            <a class="button button_right button_size_2 button_theme button_js"
                                href="{{ asset('landing/assets/content/agency3/about.html') }}"><span class="button_icon"><i
                    ...
                    <div class="section mcb-section equal-height-wrap" style="padding-top:0px; padding-bottom:100px">
                        <div class="section_wrapper mcb-section-inner">
                            <div class="wrap mcb-wrap one-second valign-middle clearfix"
                                style="padding:180px 11% 140px; background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic8.jpg') }}'); background-repeat:no-repeat; background-position:center">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column">
                                        <div class="column_attr clearfix"
                                            style=" background-image:url('{{ asset('landing/assets/content/agency3/images/home_agency3_pic9.png') }}'); background-repeat:no-repeat; background-position:left top; padding:120px 40px 40px;">
                                            ...
                                            <ul class="testimonials_slider_ul">
                                                <li>
                                                    <div class="single-photo-img">
                                                        <img src="{{ asset('landing/assets/content/agency3/images/home_agency3_ourteam_1-85x85.jpg') }}"
                                                ...
                                                <li>
                                                    <div class="single-photo-img">
                                                        <img src="{{ asset('landing/assets/content/agency3/images/home_agency3_ourteam_2-85x85.jpg') }}"
                                                            class="scale-with-grid wp-post-image">
                                                    </div>
                                                    <div class="bq_wrapper">
                                                        <blockquote>
                                                ...
                                                <li>
                                                    <div class="single-photo-img">
                                                        <img src="{{ asset('landing/assets/content/agency3/images/home_agency3_ourteam_3-85x85.jpg') }}"
                                                            class="scale-with-grid wp-post-image">
                                                    </div>
                                                    <div class="bq_wrapper">
                                                        <blockquote>
